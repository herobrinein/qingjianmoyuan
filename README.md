...
![Version](https://img.shields.io/badge/version-1.4.4-blue)  ![License](https://img.shields.io/badge/license-MIT-green)  ![PWA](https://img.shields.io/badge/PWA-Supported-orange) ![Powered](https://img.shields.io/badge/Powered_by-AI-red)
...
**[👉 国内可以用这个](https://s4.v100.vip:40444/)**
...
*   **数据来源**：本项目的核心诗词数据来源于 **[chinese-gushiwen](https://github.com/caoxingyu/chinese-gushiwen)** 开源数据集，特此感谢 [@caoxingyu](https://github.com/caoxingyu) 的整理与贡献。
...
![设置](./readme_images/settings2.png)
